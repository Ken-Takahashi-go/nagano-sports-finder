    ...
    <div className="container mx-auto px-4 py-6 max-w-6xl">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6 space-y-2">
        ...
        <div className="flex flex-wrap gap-2 text-sm items-center">
          ...
          <FilterLink current={searchParams} param="municipality" value="上田市" label="上田市" />
          <FilterLink current={searchParams} param="municipality" value="須坂市" label="須坂市" />
          ...
          <FilterLink current={searchParams} param="municipality" value="安曇野市" label="安曇野市" />
        </div>
        {/* 競技・属性 */}
